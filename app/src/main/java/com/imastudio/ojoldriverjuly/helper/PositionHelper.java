package com.imastudio.ojoldriverjuly.helper;
...
//        InitLibrary.getInstance().request_posisi(sesi.getIdDriver(),String.valueOf(lat),String.valueOf(lng)).enqueue(new Callback<ResponseDaftar>() {
//            @Override
